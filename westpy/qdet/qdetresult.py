...
class QDETResult(object):
    ...
    def __read_occupation_from_JSON(self, filename):
        ...
        for ispin in range(self.nspin):
            ...
            occ_[ispin, :] = np.array(raw_['output']['Q'][string1]['occupation'], dtype=float)
    ...
    def __read_matrix_elements_from_JSON(self, filename):
        ...
        eri = np.zeros((self.nspin, self.nspin, len(self.basis), len(self.basis), len(self.basis), len(self.basis)))
        for ispin in range(self.nspin):
            for jspin in range(self.nspin):
                for ipair in range(len(indexmap)):
                    ...
                    for jpair in range(len(indexmap)):
                        k, l = indexmap[jpair]
                        eri[ispin, jspin, i-1, j-1, k-1, l-1] = eri_pair[ispin, jspin, ipair, jpair]
                        eri[ispin, jspin, i-1, j-1, l-1, k-1] = eri_pair[ispin, jspin, ipair, jpair]
                        eri[ispin, jspin, j-1, i-1, k-1, l-1] = eri_pair[ispin, jspin, ipair, jpair]
                        eri[ispin, jspin, j-1, i-1, l-1, k-1] = eri_pair[ispin, jspin, ipair, jpair]
        
                        eri[ispin, jspin, k-1, l-1, i-1, j-1] = eri_pair[ispin, jspin, ipair, jpair]
                        eri[ispin, jspin, k-1, l-1, j-1, i-1] = eri_pair[ispin, jspin, ipair, jpair]
                        eri[ispin, jspin, l-1, k-1, i-1, j-1] = eri_pair[ispin, jspin, ipair, jpair]
                        eri[ispin, jspin, l-1, k-1, j-1, i-1] = eri_pair[ispin, jspin, ipair, jpair]
        return h1e, eri
